...
// translator id
#define FASTNOISE_TRANSLATOR "ArnoldFAstNoiseTranslator"

class ArnoldFAstNoiseTranslator : public AbstractGvShaderTranslator
{
public:
   ...
   /// Constructor.
   ///
   ArnoldFAstNoiseTranslator(BaseList2D* node, RenderContext* context);
